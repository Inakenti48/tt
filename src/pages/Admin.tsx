        ...
        <div className="p-8">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-primary/5">
              {[
                { id: '#9283', customer: 'alex@example.com', status: 'pending', amount: '$450' },
                { id: '#9282', customer: 'martha.j@test.com', status: 'delivered', amount: '$85' },
                { id: '#9281', customer: 'zen_user@web.com', status: 'delivered', amount: '$120' },
              ].map((order) => (
                <tr key={order.id} className="text-sm">
                  ...
                  <td className="py-4">
                    <span className={cn(
                      ...
                      order.status === 'pending' ? "bg-mustard/10 text-mustard" : "bg-primary/5 text-primary"
                    )}>
                      {order.status}
                    </span>
                  </td>
